                ...
                <div class="col-lg">
                    <div class="p-5">
                        <div class="text-center">
                            ...
                            <h1 class="h4 text-gray-900 mb-4 pt-3">Register Akun</h1>
                        </div>
                        <form class="user" method="post" action="<?= base_url('auth/registration'); ?>">
                            ...
                            <div class="form-group">
                                <select class="custom-select" id="divisi" name="divisi">
                                    <option value="" selected>Unit / Divisi</option>
                                    <?php foreach ($divisiunit as $divun) : ?>
                                        <option value="<?= $divun['id']; ?>"><?= $divun['divisi']; ?></option>
                                    <?php endforeach; ?>
                                </select>
