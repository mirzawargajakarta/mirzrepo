...
class Dokumen extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['data'] = $this->Dokumen_model->getDokumen($this->session->userdata('user_id'));
        $data['menu'] = $this->db->get('user_menu')->result_array();
        writelog('List dokumen');
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('dokumen/dokumen_index', $data);
        $this->load->view('templates/footer_noclosing');
        $this->load->view('templates/plugin_datatables', $data);
        $this->load->view('dokumen/tabeldokumenaktif');
        ...
        // $data['data'] = $this->Dokumen_model->test();
        // $this->load->view('dokumen/dokumen_test', $data);
    }
